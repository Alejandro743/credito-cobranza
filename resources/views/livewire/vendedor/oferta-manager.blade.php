        ...
        <div style="flex:1; overflow-y:auto; padding:10px 12px;">
            <div style="display:flex; flex-direction:column; gap:8px;">
                ...
                <div x-data="{ n: 0, maxStock: @js((int)$p['stock']) }"
                     x-on:carrito-vaciado.window="n = 0"
                     wire:key="mod-{{ $pid2 }}"
                     style="background:#fff; border:1.5px solid #C4B5FD; border-radius:12px; padding:14px 12px; box-shadow:0 4px 18px rgba(123,111,232,0.15), 0 1px 4px rgba(123,111,232,0.08);">
