        ...
        <div style="flex:1; overflow-y:auto; padding:10px 12px;">
            <div style="display:flex; flex-direction:column; gap:8px;">
                ...
                <div x-data="{ n: 0, maxStock: @js((int)$p['stock']) }"
                    ...
                    {{-- Pie: [Agregar flex:1] [trash] [− n +] a la derecha --}}
                    <div style="display:flex; align-items:center; gap:6px;">
                        <button @click="if(n===0) n=1; $wire.agregar({{ $p['product_id'] }}, n).then(() => n=0)"
                                style="flex:1; background:#f97316; color:#fff; border:none; border-radius:8px; padding:7px 14px; font-size:13px; font-weight:700; cursor:pointer; -webkit-appearance:none; appearance:none; display:flex; align-items:center; justify-content:center; gap:6px;">
