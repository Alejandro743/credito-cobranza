...
<div class="bg-white border-b border-gray-100 px-4 py-3">
    ...
    <div class="flex items-center gap-3 mb-2" style="overflow:hidden;">
        ...
        {{-- Fade derecha: indica que hay más cards para deslizar --}}
        <div style="position:absolute; right:0; top:0; bottom:0; width:48px; pointer-events:none;
                    background:linear-gradient(to right, transparent, #fff);"></div>
        </div>
