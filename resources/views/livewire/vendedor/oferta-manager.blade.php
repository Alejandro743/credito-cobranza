    ...
    <div class="flex flex-col md:flex-row md:items-center gap-2">
        ...
        <div class="flex items-center gap-2 flex-wrap flex-1">
            ...
            <button wire:click="$set('filterLista', '')"
                ...
                <div style="width:34px; height:34px; border-radius:50%; background:{{ $selTodos ? '#F97316' : '#F3F4F6' }}; display:flex; align-items:center; justify-content:center; flex-shrink:0;">
            ...
            <button wire:click="$set('filterLista', '{{ $lid }}')"
                ...
                <div style="width:34px; height:34px; border-radius:50%; background:{{ $sel ? $col['iconBg'] : $col['bg'] }}; display:flex; align-items:center; justify-content:center; flex-shrink:0;">
