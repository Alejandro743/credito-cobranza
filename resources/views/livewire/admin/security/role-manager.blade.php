    ...
    <div wire:key="card-{{ $role->id }}"
        ...
        <div style="display:flex; gap:7px;">
            ...
            <button wire:click="openView({{ $role->id }})"
                    style="height:32px; padding:0 12px; border:1px solid #E5E7EB; border-radius:8px; background:#F9FAFB; color:#6B7280; cursor:pointer; display:flex; align-items:center; justify-content:center;">
