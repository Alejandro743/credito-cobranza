...
<div class="sm:hidden flex flex-col" style="gap:10px;">
    ...
    <div wire:key="card-{{ $u->id }}"
        ...
        <div style="background:#F8F7FF; padding:10px 14px; display:flex; align-items:center; justify-content:space-between; border-bottom:1px solid #EDE9FE;">
            <p style="font-size:14px; font-weight:700; color:#111827; margin:0; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; flex:1; margin-right:10px;">{{ $u->name }}</p>
        ...
        <div style="padding:10px 14px 12px;">
            <p style="font-size:12px; color:#7B6FE8; font-family:monospace; font-weight:600; margin:0 0 4px;">{{ $u->code }}</p>
            <p style="font-size:12px; color:#6B7280; margin:0;">
                @if($u->abreviatura)
                    Abrev.: <span style="font-family:monospace; font-weight:600;">{{ $u->abreviatura }}</span>
                @else
                    Sin abreviatura
                @endif
            </p>
