...
<div style="display:flex; flex-wrap:wrap; align-items:center; gap:8px; margin-bottom:8px;">
    ...
    <select wire:model.live="filtroCasoEstado"
            style="height:32px; padding:0 8px; border:1.5px solid #EA580C; border-radius:8px; font-size:12px; outline:none; background:#fff; cursor:pointer;">
    ...
    <select wire:model.live="filtroEstado"
            style="height:32px; padding:0 8px; border:1.5px solid #7B6FE8; border-radius:8px; font-size:12px; outline:none; background:#fff; cursor:pointer;">
    ...
    <select wire:model.live="filtroPedido"
            style="height:32px; padding:0 8px; border:1.5px solid #0369A1; border-radius:8px; font-size:12px; outline:none; background:#fff; cursor:pointer; max-width:160px;">
