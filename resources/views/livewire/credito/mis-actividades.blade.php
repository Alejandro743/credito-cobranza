...
<div style="display:flex; flex-wrap:wrap; align-items:center; gap:8px; margin-bottom:8px;">
    ...
    <select wire:model.live="filtroCasoEstado"
            style="height:32px; padding:0 8px; border:1px solid #FED7AA; border-radius:8px; font-size:12px; outline:none; background:#FFF7ED; cursor:pointer; color:#9A3412;">
    ...
    <select wire:model.live="filtroEstado"
            style="height:32px; padding:0 8px; border:1px solid #DDD6FE; border-radius:8px; font-size:12px; outline:none; background:#F5F3FF; cursor:pointer; color:#5B21B6;">
    ...
    <select wire:model.live="filtroPedido"
            style="height:32px; padding:0 8px; border:1px solid #BAE6FD; border-radius:8px; font-size:12px; outline:none; background:#F0F9FF; cursor:pointer; color:#0C4A6E; max-width:160px;">
