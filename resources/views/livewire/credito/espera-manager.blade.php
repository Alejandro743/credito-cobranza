    ...
    <div wire:key="ec-{{ $p->id }}"
        ...
        <div style="padding:10px 14px; border-top:1px solid #F3F4F6;">
            <button wire:click="ver({{ $p->id }})"
                    style="width:100%; height:34px; border:1px solid #FDE68A; border-radius:8px; background:#FFFBEB; color:#D97706; font-size:12px; font-weight:600; cursor:pointer; display:flex; align-items:center; justify-content:center; gap:5px; -webkit-appearance:none; appearance:none;">
...
<div class="hidden sm:block" style="background:#fff; border-radius:16px; border:1px solid #E5E7EB; box-shadow:0 1px 4px rgba(0,0,0,.06); overflow:hidden; display:flex; flex-direction:column; max-height:calc(100vh - 180px);">
    ...
    <div style="padding:10px 18px; display:flex; align-items:center; gap:8px; border-bottom:1px solid #F3F4F6; flex-shrink:0;">
        ...
        <span style="background:#FEF3C7; color:#D97706; font-size:11px; font-weight:600; padding:2px 8px; border-radius:99px;">{{ $pedidos->total() }}</span>
    </div>
    ...
    <table style="width:100%; min-width:800px; border-collapse:collapse; font-size:13px;">
        ...
        <tbody>
            ...
            <tr wire:key="ed-{{ $p->id }}"
                ...
                @mouseenter="$el.style.background='#FFFBEB'" @mouseleave="$el.style.background=''">
                ...
                <td style="padding:10px 14px; text-align:center;">
                    <button wire:click="ver({{ $p->id }})"
                            style="height:28px; padding:0 10px; border-radius:7px; border:1px solid #FDE68A; background:#FFFBEB; color:#D97706; font-size:11px; font-weight:600; cursor:pointer; display:inline-flex; align-items:center; gap:4px; -webkit-appearance:none; appearance:none; white-space:nowrap;"
                            @mouseenter="$el.style.background='#FEF3C7'" @mouseleave="$el.style.background='#FFFBEB'"
                            title="Ver y tomar para revisión">
