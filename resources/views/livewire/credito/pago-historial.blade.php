...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
    ...
    <table style="border-collapse:separate; border-spacing:0; width:100%; font-size:13px; min-width:700px;">
        ...
        <tbody>
            @forelse($pagos as $pg)
            <tr wire:key="pg-{{ $pg->id }}" class="hover:bg-green-50 transition-colors" style="cursor:pointer;"
                ...
                <td style="padding:8px 12px; border:0.5px solid #e5e7eb; text-align:right; font-family:monospace; font-weight:700; color:#15803D; font-size:12px;">
    ...
    <div style="background:#F0FDF4; border:1px solid #86EFAC; border-radius:14px; padding:16px 18px; margin:0 0 20px;">
        <div style="display:flex; align-items:center; gap:8px; margin-bottom:6px;">
            <button wire:click="volver"
                ...
                <span style="font-size:11px; font-weight:700; color:#15803D;">Historial</span>
            </button>
            <h1 style="flex:1; text-align:center; font-size:22px; font-weight:800; color:#166534; letter-spacing:-0.3px; margin:0;">HISTORIAL DE PAGO</h1>
            <div style="width:60px; flex-shrink:0;"></div>
        </div>
        <p style="text-align:center; font-size:22px; font-weight:800; color:#15803D; font-family:monospace; margin:4px 0 6px;">
            Bs. {{ number_format($pg->monto_total, 2) }}
        </p>
        <div style="text-align:center;">
            <span style="font-size:11px; font-weight:500; color:#6b7280;">
                Código: <span style="font-family:monospace; font-weight:700; color:#15803D;">{{ $pg->numero }}</span>
            </span>
        </div>
    </div>
