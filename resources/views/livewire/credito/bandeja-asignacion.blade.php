...
<div class="flex flex-col gap-2 mb-4">
    ...
    <div class="flex flex-wrap items-center gap-2">
        <button wire:click="selectAllFiltered"
                style="height:32px; padding:0 14px; border:1px solid #A7F3D0; border-radius:8px; background:#ECFDF5; color:#065F46; font-size:12px; font-weight:600; cursor:pointer; display:flex; align-items:center; gap:5px;">
        ...
        <button wire:click="asignarMasivo"
                style="height:32px; padding:0 14px; border:1px solid #6EE7B7; border-radius:8px; background:#D1FAE5; color:#065F46; font-size:12px; font-weight:600; cursor:pointer; display:flex; align-items:center; gap:5px;">
...
<div class="hidden sm:block" style="background:#fff; border-radius:16px; border:1px solid #E5E7EB; box-shadow:0 1px 4px rgba(0,0,0,.06); overflow:hidden; display:flex; flex-direction:column; max-height:calc(100vh - 210px);">
    ...
    <table style="width:100%; border-collapse:collapse; min-width:1100px;">
        ...
        <tr wire:key="ba-d-{{ $p->id }}"
            ...
            <td style="{{ $td }}">
                <span style="font-family:monospace; font-size:12px; font-weight:700; color:#7B6FE8;">{{ $p->numero }}</span>
            </td>
            <td style="{{ $td }}">
                <span style="font-size:12px; font-weight:600; color:#374151;">{{ $p->cliente->ci ?? '—' }}</span>
            </td>
        ...
        @empty
        <tr>
            <td colspan="14" style="padding:56px 24px; text-align:center;">
