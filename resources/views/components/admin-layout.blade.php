...
<div class="flex h-screen overflow-hidden" style="background:#F0F2F5;">
    ...
    <div class="flex-1 flex flex-col min-w-0 overflow-hidden" style="background:#F0F2F5;">
        ...
        <header class="flex items-center gap-3 px-4 flex-shrink-0"
            ...
            <div style="width:38px; height:38px; border-radius:11px; background:{{ $hdrIconBg }}; display:flex; align-items:center; justify-content:center; flex-shrink:0;">
                @if($moduloActivo?->icon)
                <svg width="19" height="19" fill="none" stroke="{{ $hdrIconColor }}" stroke-width="1.9"
            ...
            <div class="flex-1 min-w-0">
                ...
                @endif
                <p style="font-size:18px; font-weight:800; color:#111827; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; margin:0; line-height:1.2;">{{ $pageTitle }}</p>
            </div>
