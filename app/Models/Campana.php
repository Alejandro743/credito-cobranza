...
class Campana extends Model
{
    protected $fillable = [
        ...
        'tipo_respuesta_id', 'tipo_cancelacion_id', 'observacion_cierre',
    ];
    ...
    public function tipoRespuesta()   { return $this->belongsTo(CobranzaCatalogo::class, 'tipo_respuesta_id'); }
    public function tipoCancelacion() { return $this->belongsTo(CobranzaCatalogo::class, 'tipo_cancelacion_id'); }
