                ...
                'submodulos' => [
                    ...
                    [
                        ...
                        'children' => [
                            ...
                            ['name' => 'Stock Artículos',  'slug' => 'cat-listas',            'route_name' => 'admin.catalogo.listas',            'sort_order' => 5],
                        ],
                    ],
                    // Grupo: Definiciones
                    [
                ...
                'submodulos' => [
                    ...
                    [
                        ...
                        'children' => [
                            ...
                            ['name' => 'Motivos de Cancelación',  'slug' => 'cob-def-motivos-cancelacion',  'route_name' => 'credito.cobranza.def.motivos-cancelacion',  'sort_order' => 5],
                            ['name' => 'Estados de Caso',         'slug' => 'cob-def-estados-caso',         'route_name' => 'credito.cobranza.def.estados-caso',         'sort_order' => 6],
                            ['name' => 'Estados de Actividad',    'slug' => 'cob-def-estados-activ',         'route_name' => 'credito.cobranza.def.estados-actividad',    'sort_order' => 7],
                            ['name' => 'Tipos de Cancelación',    'slug' => 'cob-def-tipos-cancelacion',    'route_name' => 'credito.cobranza.def.tipos-cancelacion',    'sort_order' => 8],
                        ],
                    ],
                    [
